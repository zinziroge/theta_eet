...
// Purpose: 
//	 Dual fisheye‹«ŠE•t‹ß‚ğalpha blending‚µ‚Ä‰æ‘f’læ“¾
// Input:
//   dfe_img   : dual fisyeye image(dfe)
//   ud, vd    : dfe‚Ö‚ÌQÆ‰æ‘fˆÊ’u
//   cam1, cam2: camera1, camera2 î•ñ
//   which_cam : 0=cam1, 1=cam2
//   dfe_r     : QÆ‰æ‘fˆÊ’u‚Ì”¼Œa
// Output:
	...
	)
{
	...
	double rr;
	double k;	// alpha
	double t_ud, t_vd; // sub camera‚ÌQÆ‰æ‘fˆÊ’u
	double phi;
...
// lng,lat ‚Å•\Œ»‚³‚ê‚½“_‚ğ sph_1 ‚ÌÀ•WŒn‚Å•\Œ»
//   sph_1(theta‰º‘¤‚ªY²³)
void lnglat_to_sph(
	const double lng,
	const double lat,
	CvMat* sph_1 )
{
	cvmSet(sph_1, SPH_X, 0, cos(lat) * cos(lng));	// Z‚©‚çX²•ûŒü‚ğŠp“x³
